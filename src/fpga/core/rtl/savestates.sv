...
// Detect RTI at both $00:8008 and $80:8008 (LoROM mirror) so games whose
// NMI vector lands in the $80 bank also complete the save-state session.
wire rti_sel = (ca[23:0] == 24'h008008) | (ca[23:0] == 24'h808008);
